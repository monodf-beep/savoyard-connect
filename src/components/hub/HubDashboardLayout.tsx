...
export const HubDashboardLayout = ({ 
  orgName, orgLogo, isLabeled = false, loading = false 
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex flex-1">
        <div className="hidden md:block">
          <HubSidebar collapsed={sidebarCollapsed} onToggle={() => setSidebarCollapsed(!sidebarCollapsed)} />
        </div>
        ...
        <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
          <SheetContent side="left" className="p-0 w-72 flex flex-col bg-background border-r border-border">
            ...
            <ScrollArea className="flex-1">
              <HubSidebar collapsed={false} onToggle={() => setMobileMenuOpen(false)} isMobile={true} />
            </ScrollArea>
          </SheetContent>
        </Sheet>
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                {isLabeled && (
                  <Badge className="bg-secondary text-secondary-foreground">{t("dashboard.labelBadge")}</Badge>
                )}
              </div>
