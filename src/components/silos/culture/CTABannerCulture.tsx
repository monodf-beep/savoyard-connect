...
export const CTABannerCulture = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#1e3a8a] to-[#d97706]" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
          {t('siloCulture.cta.title')}
        </h2>

        <Button
          size="lg"
          onClick={() => navigate('/signup')}
          className="bg-[#d97706] text-white hover:bg-[#d97706]/90 font-bold text-lg px-10 py-6 min-h-[56px] mb-4 group"
        >
          {t('siloCulture.cta.button')}
          <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
        </Button>

        <p className="text-white/80 text-sm">
          {t('siloCulture.cta.subtext')}
        </p>
      </div>
    </section>
  );
