        ...
        <div className="container px-4 md:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {t("testimonials.subtitle", "Des associations de toute la région alpine nous font confiance")}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              {
                quote: "Grâce à Associacion.eu, nous avons pu mutualiser nos ressources avec 3 autres associations et économiser 40% sur nos frais de gestion.",
                author: "Marie Dupont",
                role: "Présidente",
                org: "Club Alpin de Savoie",
                avatar: "MD",
              },
              {
              ...
              {
                quote: "La transparence financière offerte par la plateforme a renforcé la confiance de nos adhérents et de nos financeurs.",
                author: "Pierre Martin",
                role: "Trésorier",
                org: "Festival des Alpes",
                avatar: "PM",
              },
            ].map((testimonial, index) => (
              <Card key={index} className="bg-card border-border/50 hover:shadow-lg transition-all">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{testimonial.role}, {testimonial.org}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-12 md:py-16 border-y border-border/50 bg-muted/20">
        <div className="container px-4 md:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500">
            {/* Placeholder logos - these would be replaced with real partner logos */}
            {["Région Savoie", "Valle d'Aosta", "Alpi Cultura", "Sport Alpin", "EU Interreg"].map((partner, index) => (
              <div 
                key={index} 
                className="flex items-center justify-center h-12 px-6 rounded-lg bg-background border border-border/50"
              >
