export const it = {
  // Hero Section
  hero: {
    title: "Connettere. Condividere. Crescere insieme.",
    subtitle: "L'hub centralizzato per le associazioni europee",
    cta: {
      start: "INIZIA",
  ...
  nav: {
    ...
    docsNetwork: "Documentazione rete",
    settings: "Impostazioni",
    organigramme: "Organigramma",
    volunteering: "Volontariato",
    valueChains: "Catene di valore",
    finance: "Finanze",
    contributors: "Contributori",
    admin: "Amministrazione",
    experts: "Esperti partner",
    ...
    siloSport: "Sport & Montagna",
    siloCulture: "Radici & Cultura",
    silosSection: "Mercati",
    ...
    moduleStore: "Store dei moduli",
    currentContext: "Spazio attuale",
  },

  // Accompagnateur Page
  accompagnateur: {
    title: "L'Accompagnatore",
    assistantName: "L'Accompagnatore",
    badge: "IA",
    greeting: "Buongiorno! Quale sfida vuoi affrontare oggi?",
    selectChallenge: "Seleziona il tuo tema",
    selectOption: "Scegli la tua risposta",
    diagnosticComplete: "Perfetto! Ho preparato il tuo piano d'azione personalizzato.",
    scrollForPlan: "👇 Scopri la tua prescrizione qui sotto",
    restart: "Ricomincia",
    ordonnanceTitle: "Il Tuo Piano d'Azione Personalizzato",
    ordonnanceSubtitle: "In base alla tua diagnosi, ecco le nostre raccomandazioni",
    categories: {
      treasury: "Tesoreria",
    ...
    cardLabels: {
      immediate: "Azione Immediata",
      expert: "Esperto Consigliato",
      resource: "Auto-Formazione",
    },
    addedToKanban: "Attività aggiunta al tuo Kanban!",
    rdvRequested: "Richiesta appuntamento inviata!",
    guideOpening: "Apertura guida...",
    needMoreHelp: "Hai bisogno di un accompagnamento più approfondito?",
  },

  // Mutualisation Page
  mutualisation: {
    title: "Spazio Mutualizzazione",
    badge: "Economia Collaborativa",
    heroTitle: "Insieme, andiamo più lontano.",
    heroSubtitle: "Partecipa a casse comuni per assumere dipendenti condivisi o co-finanziare grandi progetti.",
    launchCollect: "Lanciare una nuova raccolta",
    tabHR: "Raggruppamento Datori di Lavoro",
    tabProjects: "Progetti Cofinanziati",
    secured: "assicurate",
    associationsEngaged: "associazioni impegnate",
    reserveHours: "Prenota ore",
    collected: "raccolti",
    minTicket: "Min",
    contributors: "contributori",
    deadline: "Scadenza",
    contribute: "Contribuire finanziariamente",
    newCollectTitle: "Nuova raccolta",
    newCollectDesc: "Che tipo di esigenza vuoi mutualizzare?",
    needHR: "Esigenza HR",
    needHRDesc: "Assumere un dipendente condiviso",
    needProject: "Progetto di investimento",
    needProjectDesc: "Co-finanziare attrezzature o locali",
    participateHR: "Prenota ore",
    participateProject: "Contribuisci al progetto",
    hoursQuestion: "Di quante ore/settimana hai bisogno?",
    amountQuestion: "Quale importo vuoi contribuire?",
    hourlyRateInfo: "Tariffa oraria caricata",
    minTicketInfo: "Ticket d'ingresso minimo",
    costSummary: "Riepilogo",
    annualCost: "Costo stimato per la tua asso",
    yourContribution: "Il tuo contributo",
    confirm: "Conferma",
    errorMinHours: "Per favore prenota almeno 1 ora",
    errorMinTicket: "L'importo minimo è {{amount}}",
    successHR: "La tua prenotazione è stata registrata!",
  ...
  hub: {
    welcome: {
      ...
      titlePersonalized: "Benvenuto nella rete, {{name}}.",
      subtitle: "Esplora le risorse collaborative e connettiti con altre associazioni",
    },
    myAssociations: {
      title: "Le Mie Associazioni",
      subtitle: "Gestisci le tue organizzazioni",
      manage: "Gestisci",
      create: "Crea il mio account associazione",
      empty: "Non hai ancora un'associazione",
    },
    stats: {
      associations: "Associazioni",
      countries: "Paesi",
    ...
    comingSoon: {
      title: "Prossimamente",
      subtitle: "Funzionalità in sviluppo",
    },
    activity: {
      ...
      newAssociationName: "{{name}} si è unita alla rete",
      newProject: "Nuovo progetto collaborativo lanciato",
      newProjectName: "Progetto: {{name}}",
  ...
  pillars: {
    ...
    resources: {
      ...
      description: "Condividi e affitta attrezzature, sale e competenze tra associazioni",
    },
    projects: {
      title: "Progetti Collaborativi",
      description: "Co-crea progetti transfrontalieri con altre organizzazioni",
    },
    knowledge: {
      title: "Base di Conoscenza",
      description: "Accedi a modelli, guide e competenze condivise",
    },
  },

  // Benefits
  benefits: {
    title: "Perché unirsi all'Hub?",
    transborder: {
      title: "Collaborazione transfrontaliera",
      description: "Lavora con associazioni in tutta Europa senza barriere",
    },
    savings: {
      title: "Risparmi attraverso la condivisione",
      description: "Condividi costi e risorse per massimizzare il tuo impatto",
    },
    network: {
      title: "Rete qualificata e sicura",
      description: "Connettiti con organizzazioni verificate e certificate",
    },
  },

  // CTA Final
  cta: {
    title: "Pronto a centralizzare la tua associazione?",
  ...
  dashboard: {
    ...
    kpi: {
      connections: {
        ...
        label: "Organizzazioni partner",
      },
      resources: {
        title: "Risorse attive",
        label: "Risorse disponibili",
        badge: "prenotazioni in corso",
      },
      projects: {
        title: "Progetti collaborativi",
      ...
      savings: {
        title: "Risparmi generati",
        label: "Tramite condivisione",
      },
    },
    activity: {
      title: "Attività recente",
      viewAll: "Vedi tutta la cronologia",
      empty: "Nessuna attività recente al momento",
      events: {
        newResource: "{org} ha aggiunto una nuova risorsa",
        partnershipAccepted: "La tua richiesta di partnership è stata accettata",
        newProject: "Nuovo progetto collaborativo disponibile",
        reservationConfirmed: "Prenotazione confermata per {resource}",
      },
    },
    quickActions: {
      title: "Azioni rapide",
    ...
    onboarding: {
      title: "Completa il tuo profilo per sbloccare tutte le funzionalità",
      completed: "completato",
      steps: {
        accountCreated: "Account creato",
        logoAdded: "Logo aggiunto",
  ...
  experts: {
    navTitle: "Esperti",
    memberDiscount: "Tariffa membro: -{discount}%",
    viewProfile: "Vedi profilo & contatta",
    hero: {
      badge: "Tariffe preferenziali per i membri della rete",
      title: "I Nostri Esperti al Tuo Servizio",
      subtitle: "Professionisti di fiducia per accompagnare la tua associazione quotidianamente",
    },
    modal: {
      expertises: "Aree di competenza",
      pricing: "Tariffe",
      marketRate: "Tariffa di mercato",
      memberRate: "Tariffa membro Associacion",
      quotesAvailable: "Pacchetti disponibili su preventivo",
      memberDiscountInfo: "sulla tariffa di mercato per i membri",
      pricingHidden: "Tariffe esatte riservate ai membri",
      loginRequired: "Crea il tuo account gratuito per contattare questo esperto",
      createAccount: "Crea un account gratuito",
      alreadyMember: "Ho già un account",
    },
    form: {
      title: "Contatta questo esperto",
      name: "Il tuo nome",
      namePlaceholder: "Nome Cognome",
      email: "Email",
      association: "Associazione",
      associationPlaceholder: "Nome della tua associazione",
      needType: "Tipo di esigenza",
      selectNeed: "Seleziona un'area",
      message: "Il tuo messaggio",
      messagePlaceholder: "Descrivi il tuo progetto in poche righe...",
      acceptContact: "Accetto di essere ricontattato da questo esperto",
      acceptRequired: "Accetta di essere ricontattato",
    ...
    cta: {
      title: "Accedi ai nostri esperti partner",
      subtitle: "Crea il tuo account gratuito per beneficiare delle tariffe preferenziali e contattare i nostri esperti.",
  ...
  directory: {
    ...
    profile: {
      ...
      noProjects: "Nessun progetto pubblico al momento.",
      teamStructure: "Struttura del team",
      sectionLabel: "Sezione",
      noTeamInfo: "Informazioni sul team non disponibili.",
    },
    cta: {
